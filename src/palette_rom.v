...
module palette_rom(
	...
	initial begin
		palette[0][0] = 6'b000000; // violet (default)
		palette[0][1] = 6'b000001;
		palette[0][2] = 6'b010001;
		palette[0][3] = 6'b010010;
		palette[0][4] = 6'b100010;
		palette[0][5] = 6'b100011;
		palette[0][6] = 6'b110011;
		palette[0][7] = 6'b110111;
